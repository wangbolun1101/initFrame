...
public class WorkflowMainTableInfo  implements java.io.Serializable {
    private com.yunker.yayun.oaPackage.WorkflowRequestTableRecord[] requestRecords;
    ...
    public WorkflowMainTableInfo(
           com.yunker.yayun.oaPackage.WorkflowRequestTableRecord[] requestRecords,
     ...
     */
    public com.yunker.yayun.oaPackage.WorkflowRequestTableRecord[] getRequestRecords() {
        return requestRecords;
    }
     ...
     */
    public void setRequestRecords(com.yunker.yayun.oaPackage.WorkflowRequestTableRecord[] requestRecords) {
        this.requestRecords = requestRecords;
    }
