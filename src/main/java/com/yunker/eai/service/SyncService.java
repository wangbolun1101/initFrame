...
//
//            //查询erp账套
//            String ERPSql="select id,customItem3__c,customItem4__c from customEntity63__c where customItem2__c is null and (customItem5__c<>'同步完成' or customItem5__c is null) and customItem3__c is not null and approvalStatus = 3";
