...
public class WorkflowServiceLocator extends org.apache.axis.client.Service implements com.yunker.eai.oaPackage.WorkflowService {
...
//    private java.lang.String WorkflowServiceHttpPort_address = "http://10.10.0.251:8089/services/WorkflowService";
    ...
    public com.yunker.eai.oaPackage.WorkflowServicePortType getWorkflowServiceHttpPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.yunker.eai.oaPackage.WorkflowServicePortType getWorkflowServiceHttpPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.yunker.eai.oaPackage.WorkflowServiceHttpBindingStub _stub = new com.yunker.eai.oaPackage.WorkflowServiceHttpBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.yunker.eai.oaPackage.WorkflowServicePortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.yunker.eai.oaPackage.WorkflowServiceHttpBindingStub _stub = new com.yunker.eai.oaPackage.WorkflowServiceHttpBindingStub(new java.net.URL(WorkflowServiceHttpPort_address), this);
                _stub.setPortName(getWorkflowServiceHttpPortWSDDServiceName());
                return _stub;
            }
        }
